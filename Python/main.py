...
class MainWidget(QWidget):
    ...
    def onSetButtonToggled(self):
        ...
        if self.out1Button.isChecked():
            sendStr = 'SET,' + '1,' +  self.nameEdit.text() + ',' + self.drugEdit.text() + ',' + str(self.outSpinBox.value()) + ',' + str(self.weightSpinBox.value()) + '\n'
        if self.out2Button.isChecked():
            sendStr = 'SET,' + '2,' +  self.nameEdit.text() + ',' + self.drugEdit.text() + ',' + str(self.outSpinBox.value()) + ',' + str(self.weightSpinBox.value()) + '\n'
        if self.out3Button.isChecked():
            sendStr = 'SET,' + '3,' +  self.nameEdit.text() + ',' + self.drugEdit.text() + ',' + str(self.outSpinBox.value()) + ',' + str(self.weightSpinBox.value()) + '\n'
        if self.out4Button.isChecked():
            sendStr = 'SET,' + '4,' +  self.nameEdit.text() + ',' + self.drugEdit.text() + ',' + str(self.outSpinBox.value()) + ',' + str(self.weightSpinBox.value()) + '\n'
        if self.out5Button.isChecked():
            sendStr = 'SET,' + '5,' +  self.nameEdit.text() + ',' + self.drugEdit.text() + ',' + str(self.outSpinBox.value()) + ',' + str(self.weightSpinBox.value()) + '\n'
